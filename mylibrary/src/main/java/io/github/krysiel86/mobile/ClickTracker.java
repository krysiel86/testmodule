...
import io.github.krysiel86.mobile.http.HTTPGet;
import io.github.krysiel86.mobile.http.HTTPResponse;

class ClickTracker {
    private String url;
    private boolean fired = false;
    private Context context;
    private io.github.krysiel86.mobile.ClickTrackerListener clickTrackerListener;

    static ClickTracker createAndFire(String url, Context context, io.github.krysiel86.mobile.ClickTrackerListener clickTrackerListener) {
        ClickTracker clickTracker = new ClickTracker(url, context, clickTrackerListener);
        clickTracker.fire();
        return clickTracker;
    }

    private ClickTracker(String url, Context context, io.github.krysiel86.mobile.ClickTrackerListener clickTrackerListener) {
        this.url = url;
