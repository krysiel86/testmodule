...
package io.github.krysiel86.mobile;
...
import io.github.krysiel86.mobile.rendering.sdk.UserConsentUtils;
...
public class TargetingParams {
    ...
    public static void addUserData(
        ...
        io.github.krysiel86.mobile.Util.addValue(userDataMap, key, value);
    }
     ...
     */
    public static void storeExternalUserId(io.github.krysiel86.mobile.ExternalUserId externalUserId) {
        if (externalUserId != null) {
            io.github.krysiel86.mobile.StorageUtils.storeExternalUserId(externalUserId);
        } else {
     ...
     */
    public static io.github.krysiel86.mobile.ExternalUserId fetchStoredExternalUserId(@NonNull String source) {
        if (!TextUtils.isEmpty(source)) {
            return io.github.krysiel86.mobile.StorageUtils.fetchStoredExternalUserId(source);
        }
        return null;
    }
    ...
    public static List<ExternalUserId> fetchStoredExternalUserIds() {
        return io.github.krysiel86.mobile.StorageUtils.fetchStoredExternalUserIds();
    }
    ...
    public static void removeStoredExternalUserId(@NonNull String source) {
        if (!TextUtils.isEmpty(source)) {
            io.github.krysiel86.mobile.StorageUtils.removeStoredExternalUserId(source);
        }
    }
    ...
    public static void clearStoredExternalUserIds() {
        io.github.krysiel86.mobile.StorageUtils.clearStoredExternalUserIds();
    }
    ...
    public static void addContextData(
        ...
        io.github.krysiel86.mobile.Util.addValue(extDataDictionary, key, value);
    }
