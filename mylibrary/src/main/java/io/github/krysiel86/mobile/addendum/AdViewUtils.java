...
package io.github.krysiel86.mobile.addendum;
...
import io.github.krysiel86.mobile.CacheManager;
import io.github.krysiel86.mobile.LogUtil;
import io.github.krysiel86.mobile.PrebidNativeAd;
import io.github.krysiel86.mobile.PrebidNativeAdListener;
...
public final class AdViewUtils {
    ...
    private static PrebidNativeAd createPrebidNativeAd(String cacheId, PrebidNativeAdListener listener) {
        Class clazz = null;
        try {
            clazz = Class.forName("io.github.krysiel86.mobile.PrebidNativeAd");
