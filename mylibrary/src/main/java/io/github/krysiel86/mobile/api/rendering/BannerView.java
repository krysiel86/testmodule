...
import io.github.krysiel86.mobile.api.data.BannerAdPosition;
import io.github.krysiel86.mobile.api.data.VideoPlacementType;
import io.github.krysiel86.mobile.api.exceptions.AdException;
import io.github.krysiel86.mobile.api.rendering.DisplayView;
import io.github.krysiel86.mobile.api.rendering.listeners.BannerVideoListener;
import io.github.krysiel86.mobile.api.rendering.listeners.BannerViewListener;
...
import io.github.krysiel86.mobile.rendering.bidding.interfaces.BannerEventHandler;
import io.github.krysiel86.mobile.rendering.bidding.interfaces.StandaloneBannerEventHandler;
import io.github.krysiel86.mobile.rendering.bidding.listeners.BannerEventListener;
...
import io.github.krysiel86.mobile.rendering.bidding.loader.BidLoader;
...
import io.github.krysiel86.mobile.rendering.utils.broadcast.ScreenStateReceiver;
import io.github.krysiel86.mobile.rendering.utils.helpers.VisibilityChecker;
...
public class BannerView extends FrameLayout {
    ...
    private BidRequesterListener bidRequesterListener = new BidRequesterListener() {
        ...
        public void onFetchCompleted(BidResponse response) {
            Log.e("tpmn", "bidRequesterListener onFetchCompleted");
    ...
    public void setPluginEventListener(PluginEventListener pluginEventListener) {
        Log.e("tpmn", "setPluginEventListener");
    ...
    private void initAdConfiguration() {
        Log.e("tpmn", "BannerView initAdConfiguration()");
    ...
    private void initBidLoader() {
        Log.e("tpmn", "BannerView initBidLoader()");
    ...
    private void displayAdServerView(View view) {
        Log.e("tpmn", "displayAdServerView()");
        removeAllViews();
