...
import io.github.krysiel86.mobile.rendering.utils.broadcast.local.EventForwardingLocalBroadcastReceiver;
import io.github.krysiel86.mobile.rendering.utils.constants.IntentActions;
...
import io.github.krysiel86.mobile.rendering.views.video.VideoViewListener;
...
public class PrebidDisplayView extends FrameLayout {
    ...
    @Nullable
    private io.github.krysiel86.mobile.api.rendering.VideoView videoView;
    ...
    private final VideoViewListener videoViewListener = new VideoViewListener() {
        ...
        public void onLoaded(
                @NonNull io.github.krysiel86.mobile.api.rendering.VideoView videoAdView,
                AdDetails adDetails
        ) {
        ...
        @Override
        public void onPlayBackCompleted(@NonNull io.github.krysiel86.mobile.api.rendering.VideoView videoAdView) {
    ...
    public PrebidDisplayView(
        ...
        winNotifier.notifyWin(response, () -> {
            try {
                Log.e("tpmn","winNotifier.notifyWin");
                ...
                Log.e("tpmn","winNotifier.notifyWin impressionEventUrl : " + impressionEventUrl);
            } catch (AdException e) {
