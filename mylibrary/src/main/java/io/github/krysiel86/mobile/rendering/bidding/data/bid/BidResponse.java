...
public class BidResponse {
    ...
    public BidResponse(
        ...
        Log.e("tpmn", "BidResponse BidResponse");
    ...
    private void parseJson(String json) {
        ...
        try {
            ...
            Log.e("tpmn", "BidResponse parseJson responseJson : " + responseJson);
    ...
    public boolean isVideo() {
        ...
        if (bid != null) {
            Log.e("tpmn","isVideo " + Utils.isVast(bid.getAdm()));
    ...
    private boolean hasWinningKeywords(Prebid prebid) {
        Log.e("tpmn", "hasWinningKeywords prebid : " + prebid.getTargeting());
