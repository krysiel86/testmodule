...
package io.github.krysiel86.mobile.rendering.bidding.loader;
...
import io.github.krysiel86.mobile.rendering.models.openrtb.bidRequests.MobileSdkPassThrough;
...
import io.github.krysiel86.mobile.rendering.networking.modelcontrollers.BidRequester;
import io.github.krysiel86.mobile.rendering.networking.parameters.AdRequestInput;
import io.github.krysiel86.mobile.rendering.utils.helpers.RefreshTimerTask;
...
public class BidLoader {
    ...
    private final ResponseHandler responseHandler = new ResponseHandler() {
        ...
        public void onResponse(BaseNetworkTask.GetUrlResult response) {
            Log.e("tpmn","BidLoader onResponse");
            ...
            if (requestListener != null) {
                setupRefreshTimer();
                Log.e("tpmn","BidLoader ResponseHandler onResponse : " + bidResponse.getWinningBid());
    ...
    public void load() {
        ...
        Log.e("tpmn","BidLoader load() adConfiguration getConfigId : " + adConfiguration.getConfigId());
...
//            LogUtil.debug(TAG, "setupRefreshTimer: Canceled. AdConfiguration is null or AdType is not Banner");
    ...
    private void updateAdUnitConfiguration(@NonNull BidResponse bidResponse) {
        Log.e("tpmn","updateAdUnitConfiguration");
