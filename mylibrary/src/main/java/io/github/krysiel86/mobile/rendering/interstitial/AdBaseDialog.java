...
package io.github.krysiel86.mobile.rendering.interstitial;
...
import io.github.krysiel86.mobile.rendering.mraid.methods.others.OrientationManager;
...
import io.github.krysiel86.mobile.rendering.utils.broadcast.OrientationBroadcastReceiver;
...
import io.github.krysiel86.mobile.rendering.views.interstitial.InterstitialVideo;
...
public abstract class AdBaseDialog extends Dialog {
    ...
    private io.github.krysiel86.mobile.rendering.interstitial.DialogEventListener listener;
    ...
    protected void addSoundView(boolean isMutedOnStart) {
        ...
        soundView.setOnClickListener(view -> {
            if (listener != null) {
                ...
                if (tag.equals("off")) {
                    listener.onEvent(io.github.krysiel86.mobile.rendering.interstitial.DialogEventListener.EventType.MUTE);
                    img.setImageResource(R.drawable.ic_volume_on);
                    img.setTag("on");
                } else {
                    listener.onEvent(io.github.krysiel86.mobile.rendering.interstitial.DialogEventListener.EventType.UNMUTE);
    ...
    private static class OnDialogShowListener implements OnShowListener {
        ...
        public void onShow(DialogInterface dialog) {
            ...
            final io.github.krysiel86.mobile.rendering.interstitial.DialogEventListener listener = adBaseDialog.listener;
