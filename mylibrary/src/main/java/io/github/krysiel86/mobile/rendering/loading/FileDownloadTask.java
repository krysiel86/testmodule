...
import io.github.krysiel86.mobile.rendering.errors.ServerWrongStatusCode;
...
public class FileDownloadTask extends BaseNetworkTask {
    ...
    protected io.github.krysiel86.mobile.rendering.loading.FileDownloadListener listener;
    protected File file;
    ...
    public GetUrlResult customParser(int code, URLConnection urlConnection) {
        Log.e("tpmn", "FileDownloadTask customParser");
    ...
    protected void onPostExecute(GetUrlResult urlResult) {
        Log.e("tpmn", "FileDownloadTask onPostExecute");
