...
package io.github.krysiel86.mobile.rendering.manager;
...
import com.iab.omid.library.mesonai.ScriptInjector;
...
import com.iab.omid.library.mesonai.adsession.media.InteractionType;
import com.iab.omid.library.mesonai.adsession.media.MediaEvents;
import com.iab.omid.library.mesonai.adsession.media.Position;
...
import io.github.krysiel86.mobile.rendering.video.vast.Verification;
...
public class OmAdSessionManager {
    ...
    public static final String PARTNER_NAME = "krysiel"; // "Prebid";
    public static final String PARTNER_VERSION = "2.1.6";
    ...
    public String injectValidationScriptIntoHtml(String html) {
        Log.e("tpmn", "injectValidationScriptIntoHtml");
    ...
    public void initWebAdSessionManager(WebView adView, String contentUrl) {
        Log.e("tpmn", "initWebAdSessionManager");
