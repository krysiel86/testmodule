...
import io.github.krysiel86.mobile.rendering.listeners.CreativeResolutionListener;
...
public abstract class AbstractCreative {
    ...
    private io.github.krysiel86.mobile.rendering.models.CreativeModel model;
    ...
    public AbstractCreative(
            Context context,
            io.github.krysiel86.mobile.rendering.models.CreativeModel model,
    ...
    /**
     * @return {@link io.github.krysiel86.mobile.rendering.models.CreativeModel} which can be used to track events or to access specific creative ad configuration.
     */
    @NonNull
