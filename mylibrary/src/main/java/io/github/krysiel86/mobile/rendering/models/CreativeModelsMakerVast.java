...
import static io.github.krysiel86.mobile.rendering.parser.AdResponseParserVast.RESOURCE_FORMAT_HTML;
import static io.github.krysiel86.mobile.rendering.parser.AdResponseParserVast.RESOURCE_FORMAT_IFRAME;
import static io.github.krysiel86.mobile.rendering.parser.AdResponseParserVast.RESOURCE_FORMAT_STATIC;
...
import io.github.krysiel86.mobile.rendering.parser.AdResponseParserBase;
import io.github.krysiel86.mobile.rendering.parser.AdResponseParserVast;
...
import io.github.krysiel86.mobile.rendering.video.VideoCreativeModel;
...
public class CreativeModelsMakerVast extends CreativeModelsMaker {
    ...
    private void makeModelsContinued() {
        try {
            Log.e("tpmn","CreativeModelsMakerVast makeModelsContinued()");
            ...
            if (companionAd != null) {
                switch (AdResponseParserVast.getCompanionResourceFormat(companionAd)) {
                    ...
                    case RESOURCE_FORMAT_STATIC:
                        Log.e("tpmn","RESOURCE_FORMAT_STATIC");
