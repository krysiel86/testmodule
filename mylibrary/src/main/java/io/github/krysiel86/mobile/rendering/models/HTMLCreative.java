...
import io.github.krysiel86.mobile.rendering.interstitial.InterstitialManagerDisplayDelegate;
import io.github.krysiel86.mobile.rendering.listeners.CreativeViewListener;
import io.github.krysiel86.mobile.rendering.listeners.WebViewDelegate;
import io.github.krysiel86.mobile.rendering.manager.OmAdSessionManager;
import io.github.krysiel86.mobile.rendering.models.AbstractCreative;
import io.github.krysiel86.mobile.rendering.models.CreativeModel;
import io.github.krysiel86.mobile.rendering.models.CreativeVisibilityTracker;
import io.github.krysiel86.mobile.rendering.models.TrackingEvent;
import io.github.krysiel86.mobile.rendering.models.ViewPool;
import io.github.krysiel86.mobile.rendering.models.internal.MraidEvent;
import io.github.krysiel86.mobile.rendering.models.internal.VisibilityTrackerOption;
import io.github.krysiel86.mobile.rendering.models.internal.VisibilityTrackerResult;
import io.github.krysiel86.mobile.rendering.models.ntv.NativeEventTracker;
import io.github.krysiel86.mobile.rendering.mraid.methods.MraidController;
...
import io.github.krysiel86.mobile.rendering.views.webview.PrebidWebViewBanner;
import io.github.krysiel86.mobile.rendering.views.webview.PrebidWebViewBase;
import io.github.krysiel86.mobile.rendering.views.webview.PrebidWebViewInterstitial;
...
public class HTMLCreative extends AbstractCreative implements WebViewDelegate, InterstitialManagerDisplayDelegate, Comparable {
    ...
    public void handleMRAIDEventsInCreative(final MraidEvent mraidEvent, final WebViewBase oldWebViewBase) {
        Log.e("tpmn", "handleMRAIDEventsInCreative");
        if (mraidController == null) {
