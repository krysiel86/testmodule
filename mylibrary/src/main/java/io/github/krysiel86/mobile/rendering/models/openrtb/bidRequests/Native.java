...
import io.github.krysiel86.mobile.NativeAsset;
import io.github.krysiel86.mobile.NativeEventTracker;
...
public class Native extends BaseBid {
    ...
    private io.github.krysiel86.mobile.rendering.models.openrtb.bidRequests.Ext ext;
    ...
    public io.github.krysiel86.mobile.rendering.models.openrtb.bidRequests.Ext getExt() {
        if (ext == null) {
            ext = new Ext();
        }
        return ext;
