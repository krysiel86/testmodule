...
package io.github.krysiel86.mobile.rendering.networking;
...
import io.github.krysiel86.mobile.rendering.networking.BaseResponseHandler;
import io.github.krysiel86.mobile.rendering.networking.ResponseHandler;
import io.github.krysiel86.mobile.rendering.networking.exception.BaseExceptionHolder;
...
//        LogUtil.debug(TAG, "responseString Result : " + urlResult.responseString);
        LogUtil.debug("tpmn", "onPostExecute Result: " + urlResult.responseString);
    ...
    public GetUrlResult sendRequest(GetUrlParams param) throws Exception {
        ...
        LogUtil.debug("tpmn", "BaseNetWork send Request url : " + param.url +
                "\n/ BaseNetWork queryParams : " + param.queryParams + "\n/ BaseNetWork name : " + param.name);
...
//        Log.e("tpmn","responseCode : " + responseCode);
//        Log.e("tpmn", "result result : " + result);
    ...
    protected String readResponse(
        ...
        LogUtil.debug("tpmn", "BaseNetworkTast readResponse  response  : " + response.toString());
    ...
    private GetUrlResult processDoInBackground(GetUrlParams... params) {
        ...
        if (isCancelled()) {
            ...
            try {
                ...
                LogUtil.debug("tpmn", "BaseNetworkTast processDoInBackground  : " + params[0].url + "// result : " + result.originalUrl);
    ...
    private URLConnection setHttpURLConnectionProperty(GetUrlParams param) throws Exception {
        Log.e("tpmn", "setHttpURLConnectionProperty");
        String queryParams = "";
        if (param.requestType.equals("GET") && param.queryParams != null) {
            queryParams = "?" + param.queryParams;
            Log.e("tpmn", "setHttpURLConnectionProperty queryParams : " + queryParams);
        }

        URL url = new URL(param.url + queryParams);
        Log.e("tpmn", "setHttpURLConnectionProperty url : " + url);
...
//        Log.e("tpmn", "setHttpURLConnectionProperty connection1 : " + connection);

        connection = openConnectionCheckRedirects(connection);

        Log.e("tpmn", "setHttpURLConnectionProperty connection2 : " + connection.getURL());
    ...
    private URLConnection openConnectionCheckRedirects(URLConnection connection) throws Exception {
        Log.e("tpmn", "openConnectionCheckRedirects");
    ...
    private GetUrlResult parseHttpURLResponse(int httpURLResponseCode) throws Exception {
        ...
        Log.e("tpmn", "parseHttpURLResponse responseString : " + result.responseString + "\n/ contentType : " + result.contentType + "/ JSRedirectURI :" + result.JSRedirectURI + "/");
