...
public class WinNotifier {
    ...
    private final ResponseHandler winResponseHandler = new ResponseHandler() {
        ...
        public void onResponse(BaseNetworkTask.GetUrlResult response) {
            ...
            Log.e("tpmn", "WinNotifier onResponse");
            if (isJson(responseString)) {
                adMarkup = extractAdm(responseString);
            } else {
                adMarkup = responseString;
            }
            Log.e("tpmn", "WinNotifier winResponseHandler : " + adMarkup);
            bid.setAdm(adMarkup);
            sendNextWinRequest();
        }
    ...
    public void notifyWin(BidResponse bidResponse,
        ...
        Log.e("tpmn", "WinNotifier cacheIdUrl : " + cacheIdUrl);
        Log.e("tpmn", "WinNotifier uuidUrl : " + uuidUrl);
        Log.e("tpmn", "WinNotifier winUrl : " + winUrl);
        Log.e("tpmn", "WinNotifier urlQueue : " + urlQueue);
        sendNextWinRequest();
    }
    ...
    private void sendNextWinRequest() {
        ...
        Log.e("tpmn", "sendNextWinRequest winUrl : " + winUrl);
    ...
    private String getCacheUrlFromBid(Bid bid, String idKey) {
        Log.e("tpmn", "WinNotifier getCacheUrlFromBid");
    ...
    private String extractAdm(String response) {
        try {
            ...
            Log.e("tpmn", "extractAdm : " + responseJson.getString("adm"));
