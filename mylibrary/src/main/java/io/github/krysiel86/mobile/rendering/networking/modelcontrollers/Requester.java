...
import io.github.krysiel86.mobile.rendering.listeners.AdIdFetchListener;
...
import io.github.krysiel86.mobile.rendering.networking.parameters.AppInfoParameterBuilder;
import io.github.krysiel86.mobile.rendering.networking.parameters.BasicParameterBuilder;
import io.github.krysiel86.mobile.rendering.networking.parameters.DeviceInfoParameterBuilder;
import io.github.krysiel86.mobile.rendering.networking.parameters.GeoLocationParameterBuilder;
import io.github.krysiel86.mobile.rendering.networking.parameters.NetworkParameterBuilder;
import io.github.krysiel86.mobile.rendering.networking.parameters.ParameterBuilder;
import io.github.krysiel86.mobile.rendering.networking.parameters.UserConsentParameterBuilder;
...
import io.github.krysiel86.mobile.rendering.networking.urlBuilder.URLBuilder;
import io.github.krysiel86.mobile.rendering.networking.urlBuilder.URLComponents;
...
import io.github.krysiel86.mobile.rendering.sdk.deviceData.managers.ConnectionInfoManager;
...
import io.github.krysiel86.mobile.rendering.utils.helpers.AdIdManager;
...
//    private static final String TAG = Requester.class.getSimpleName();
    private static final String TAG = "tpmn Requester";
    ...
    protected List<ParameterBuilder> getParameterBuilders() {
        Log.e("tpmn", "getParameterBuilders");
    ...
    protected URLComponents buildUrlComponent() {
        Log.e("tpmn", "URLComponents buildUrlComponent()");
        return urlBuilder.buildUrl();
    }

    protected void sendAdRequest(URLComponents jsonUrlComponents) {
        Log.e("tpmn", "Requester sendAdRequest : " + jsonUrlComponents);
