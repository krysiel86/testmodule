...
import static io.github.krysiel86.mobile.PrebidMobile.SDK_VERSION;
...
import io.github.krysiel86.mobile.ExternalUserId;
import io.github.krysiel86.mobile.PrebidMobile;
import io.github.krysiel86.mobile.Signals;
import io.github.krysiel86.mobile.TargetingParams;
...
import io.github.krysiel86.mobile.rendering.bidding.data.bid.Prebid;
...
import io.github.krysiel86.mobile.rendering.models.openrtb.bidRequests.Imp;
import io.github.krysiel86.mobile.rendering.models.openrtb.bidRequests.User;
import io.github.krysiel86.mobile.rendering.models.openrtb.bidRequests.devices.Geo;
import io.github.krysiel86.mobile.rendering.models.openrtb.bidRequests.imps.Banner;
import io.github.krysiel86.mobile.rendering.models.openrtb.bidRequests.imps.Video;
import io.github.krysiel86.mobile.rendering.models.openrtb.bidRequests.source.Source;
...
public class BasicParameterBuilder extends ParameterBuilder {
    ...
    public void appendBuilderParameters(AdRequestInput adRequestInput) {
        Log.e("tpmn", "BasicParameterBuilder appendUserTargetingParameters");
    ...
    private void configureBidRequest(BidRequest bidRequest, String uuid) {
        Log.e("tpmn","BasicParameterBuilder configureBidRequest BidRequest : " + bidRequest + " / uuid : " + uuid);
    ...
    private void appendUserTargetingParameters(AdRequestInput adRequestInput) {
        Log.e("tpmn", "appendUserTargetingParameters");
