...
package io.github.krysiel86.mobile.rendering.networking.urlBuilder;
...
import io.github.krysiel86.mobile.rendering.networking.urlBuilder.BidUrlComponents;
import io.github.krysiel86.mobile.rendering.networking.urlBuilder.URLPathBuilder;
...
public class URLBuilder {
    ...
    static AdRequestInput buildParameters(ArrayList<ParameterBuilder> paramBuilders, AdRequestInput adRequestInput) {
        Log.e("tpmn", "URLBuilder buildParameters");
        ...
        for (ParameterBuilder builder : paramBuilders) {
            // 여기서 등록?
            Log.e("tpmn","builder.appendBuilderParameters(newAdRequestInput)");
