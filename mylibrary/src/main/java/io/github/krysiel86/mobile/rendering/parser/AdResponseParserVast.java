...
package io.github.krysiel86.mobile.rendering.parser;
...
import io.github.krysiel86.mobile.rendering.errors.VastParseError;
import io.github.krysiel86.mobile.rendering.networking.parameters.BasicParameterBuilder;
import io.github.krysiel86.mobile.rendering.utils.helpers.Utils;
import io.github.krysiel86.mobile.rendering.video.VideoAdEvent;
import io.github.krysiel86.mobile.rendering.video.vast.Ad;
import io.github.krysiel86.mobile.rendering.video.vast.AdVerifications;
import io.github.krysiel86.mobile.rendering.video.vast.ClickTracking;
import io.github.krysiel86.mobile.rendering.video.vast.Companion;
import io.github.krysiel86.mobile.rendering.video.vast.Creative;
import io.github.krysiel86.mobile.rendering.video.vast.Extension;
import io.github.krysiel86.mobile.rendering.video.vast.Impression;
import io.github.krysiel86.mobile.rendering.video.vast.InLine;
import io.github.krysiel86.mobile.rendering.video.vast.MediaFile;
import io.github.krysiel86.mobile.rendering.video.vast.VAST;
...
public class AdResponseParserVast extends AdResponseParserBase {
    ...
    private ArrayList<io.github.krysiel86.mobile.rendering.video.vast.Tracking> trackings;
    private ArrayList<ClickTracking> clickTrackings;
    private ArrayList<Impression> impressions;

    private VAST vast;

    public ArrayList<io.github.krysiel86.mobile.rendering.video.vast.Tracking> getTrackings() {
        return trackings;
    }
    ...
    public AdResponseParserVast(String data) throws VastParseError {
        Log.e("tpmn","AdResponseParserVast: " + data);
    ...
    public String getMediaFileUrl(AdResponseParserVast parserVast, int index) {
        ...
        Log.e("tpmn","myBestMediaFileURL : " + myBestMediaFileURL);
        return myBestMediaFileURL;
    }
    ...
    public ArrayList<io.github.krysiel86.mobile.rendering.video.vast.Tracking> getTrackingEvents(VAST vast, int index) {
    ...
    public ArrayList<io.github.krysiel86.mobile.rendering.video.vast.Tracking> getAllTrackings(AdResponseParserVast parserVast, int index) {
    ...
    public ArrayList<String> getTrackingByType(VideoAdEvent.Event event) {
        Iterator<io.github.krysiel86.mobile.rendering.video.vast.Tracking> iterator = trackings.iterator();

        ArrayList<String> urls = new ArrayList<>();

        while (iterator.hasNext()) {
            io.github.krysiel86.mobile.rendering.video.vast.Tracking t = iterator.next();
     ...
     */
    public static io.github.krysiel86.mobile.rendering.video.vast.Tracking findTracking(ArrayList<io.github.krysiel86.mobile.rendering.video.vast.Tracking> trackingEvents) {
        for (io.github.krysiel86.mobile.rendering.video.vast.Tracking tracking : trackingEvents) {
