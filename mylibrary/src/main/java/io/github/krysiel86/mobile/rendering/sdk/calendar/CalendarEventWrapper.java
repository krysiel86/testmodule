...
package io.github.krysiel86.mobile.rendering.sdk.calendar;

import org.json.JSONObject;
import io.github.krysiel86.mobile.LogUtil;
import io.github.krysiel86.mobile.rendering.sdk.calendar.CalendarRepeatRule;
import io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper;
...
public final class CalendarEventWrapper
{
	...
	private io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper start;
	private io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper end;
	private Status status;
	private Transparency transparency;
	private CalendarRepeatRule recurrence;
	private io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper reminder;
    ...
    public io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper getStart()
	{
		return start;
	}
	...
	public void setStart(String start)
	{
		try
		{
			this.start = new io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper(start);
		}
    ...
    public io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper getEnd()
	{
		return end;
	}
	...
	public void setEnd(String end)
	{
		try
		{
			this.end = new io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper(end);
		}
		catch (ParseException e)
		{
    ...
    public io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper getReminder()
	{
		return reminder;
	}
