...
import io.github.krysiel86.mobile.rendering.sdk.calendar.ICalendar;
import io.github.krysiel86.mobile.rendering.utils.helpers.Utils;

final public class CalendarFactory {

    private io.github.krysiel86.mobile.rendering.sdk.calendar.ICalendar implementation;
    ...
    private CalendarFactory() {
        if (Utils.atLeastICS()) {
            ...
            implementation = new io.github.krysiel86.mobile.rendering.sdk.calendar.CalendarLT14();
        }
    }
