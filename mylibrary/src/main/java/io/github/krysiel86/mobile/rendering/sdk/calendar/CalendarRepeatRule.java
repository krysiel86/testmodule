...
public final class CalendarRepeatRule {
    ...
    private io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper expires;
    private io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper[] exceptionDates;
    ...
    public io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper getExpires() {
        return expires;
    }

    public void setExpires(String expires) {
        try {
            this.expires = new io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper(expires);
        }
    ...
    public io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper[] getExceptionDates() {
        return exceptionDates;
    }

    public void setExceptionDates(String[] exceptionDates) {
        if (exceptionDates != null) {
            this.exceptionDates = new io.github.krysiel86.mobile.rendering.sdk.calendar.DateWrapper[exceptionDates.length];
            int ind = 0;
