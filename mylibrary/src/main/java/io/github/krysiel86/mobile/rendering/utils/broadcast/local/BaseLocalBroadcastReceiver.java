...
public abstract class BaseLocalBroadcastReceiver extends BroadcastReceiver {
    ...
    public static void sendLocalBroadcast(
        ...
        @NonNull
        final String action) {
        Log.e("tpmn","BaseLocalBroadcastReceiver sendLocalBroadcast");
    ...
    public void register(
        ...
        Log.e("tpmn","BaseLocalBroadcastReceiver register");
    ...
    public boolean shouldConsumeBroadcast(
        @NonNull
        final Intent intent) {
        Log.e("tpmn","BaseLocalBroadcastReceiver shouldConsumeBroadcast");
