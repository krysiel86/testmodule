...
package io.github.krysiel86.mobile.rendering.video;
...
import io.github.krysiel86.mobile.rendering.listeners.VideoCreativeViewListener;
import io.github.krysiel86.mobile.rendering.models.ViewPool;
import io.github.krysiel86.mobile.rendering.utils.helpers.Dips;
import io.github.krysiel86.mobile.rendering.utils.helpers.InsetsUtils;
import io.github.krysiel86.mobile.rendering.utils.url.UrlHandler;
import io.github.krysiel86.mobile.rendering.utils.url.action.BrowserAction;
import io.github.krysiel86.mobile.rendering.utils.url.action.DeepLinkAction;
...
import io.github.krysiel86.mobile.rendering.video.ExoPlayerView;
import io.github.krysiel86.mobile.rendering.video.VideoAdEvent;
import io.github.krysiel86.mobile.rendering.video.VideoPlayerView;
import io.github.krysiel86.mobile.rendering.views.VolumeControlView;
...
public class VideoCreativeView extends RelativeLayout {
    ...
    private io.github.krysiel86.mobile.rendering.video.ExoPlayerView exoPlayerView;
    ...
    private void init() throws AdException {
        ...
        Log.e("tpmn","VideoCreativeView init()");
    ...
    private void addCallToActionView() {
        Log.e("tpmn","VideoCreativeView addCallToActionView()");
