...
import io.github.krysiel86.mobile.rendering.video.vast.AdSystem;
import io.github.krysiel86.mobile.rendering.video.vast.AdTitle;
import io.github.krysiel86.mobile.rendering.video.vast.AdVerifications;
import io.github.krysiel86.mobile.rendering.video.vast.Advertiser;
import io.github.krysiel86.mobile.rendering.video.vast.Creative;
import io.github.krysiel86.mobile.rendering.video.vast.Creatives;
import io.github.krysiel86.mobile.rendering.video.vast.Description;
import io.github.krysiel86.mobile.rendering.video.vast.Error;
import io.github.krysiel86.mobile.rendering.video.vast.Extensions;
import io.github.krysiel86.mobile.rendering.video.vast.Impression;
import io.github.krysiel86.mobile.rendering.video.vast.Pricing;
import io.github.krysiel86.mobile.rendering.video.vast.Survey;
...
public class InLine extends VASTParserBase {
    ...
    private io.github.krysiel86.mobile.rendering.video.vast.Error error;
    ...
    public InLine(XmlPullParser p) throws XmlPullParserException, IOException {
        ...
        while (p.next() != XmlPullParser.END_TAG) {
            ...
            if (name != null && name.equals(VAST_ADSYSTEM)) {
                ...
                error = new io.github.krysiel86.mobile.rendering.video.vast.Error(p);
