...
import io.github.krysiel86.mobile.rendering.video.vast.NonLinear;
...
public class NonLinearAds extends VASTParserBase {
	...
	private ArrayList<io.github.krysiel86.mobile.rendering.video.vast.NonLinear> nonLinearAds;
	...
	public NonLinearAds(XmlPullParser p) throws XmlPullParserException, IOException {
		...
		while (p.next() != XmlPullParser.END_TAG) {
			...
			if (name != null && name.equals(VAST_NONLINEAR))
			{
				...
				nonLinearAds.add(new io.github.krysiel86.mobile.rendering.video.vast.NonLinear(p));
