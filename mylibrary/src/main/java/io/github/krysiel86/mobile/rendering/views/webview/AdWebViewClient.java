...
public class AdWebViewClient extends WebViewClient {
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
        ...
        try {
            ...
            pageUrl = url;
            LogUtil.debug(TAG, "onPageStarted pageUrl: " + pageUrl);
    ...
    public void onPageFinished(WebView view, String url) {
        ...
        LogUtil.debug(TAG, "AdWebViewClient onPageFinished: " + view + "\n url : " + url);
        try {
    ...
    public void onLoadResource(WebView view, String url) {
      Log.e("tpmn","AdWebViewClient onLoadResource");
        if (view == null) {
            LogUtil.error(TAG, "onPageStarted failed, WebView is null");
            return;
        }
        Log.e("tpmn", "onLoadResource url: " + url);
        ...
        try {
            ...
            if (webViewBase.containsIFrame() && webViewBase.isClicked() && !urls.contains(url) && view.getHitTestResult() != null
                    && (view.getHitTestResult()
                    .getType() == SRC_ANCHOR_TYPE || view.getHitTestResult()
                    .getType() == SRC_IMAGE_ANCHOR_TYPE)) {

                Log.e("tpmn", "onLoadResource1 url: " + url);
            ...
            urls.add(url);
//            LogUtil.debug(TAG, "onLoadResource url: " + url);
            Log.e("tpmn", "onLoadResource2 url: " + url);
...
//        LogUtil.debug(TAG, "shouldOverrideUrlLoading, url: " + url);
        Log.e("tpmn","shouldOverrideUrlLoading, url : " + url);
        if (view == null) {
            LogUtil.error(TAG, "onPageStarted failed, WebView is null");
            return false;
        }
        ...
        try {
            ...
            if (!webViewBase.isClicked()) {
                ...
                Log.e("tpmn","Get the rendered HTML");
    ...
    private void reloadUrl(WebView view, String s) {
        Log.e("tpmn", "AdWebViewClient reloadUrl : " + s);
        view.stopLoading();
