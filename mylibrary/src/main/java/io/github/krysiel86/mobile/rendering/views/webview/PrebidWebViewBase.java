...
import io.github.krysiel86.mobile.rendering.listeners.WebViewDelegate;
...
import io.github.krysiel86.mobile.rendering.utils.exposure.ViewExposure;
...
public class PrebidWebViewBase extends FrameLayout implements PreloadManager.PreloadedListener, MraidEventsManager.MraidListener {
    ...
    protected io.github.krysiel86.mobile.rendering.views.webview.WebViewBase oldWebViewBase;

    protected WebViewDelegate webViewDelegate;

    protected HTMLCreative creative;

    protected io.github.krysiel86.mobile.rendering.views.webview.WebViewBase webView;
    protected io.github.krysiel86.mobile.rendering.views.webview.WebViewBanner mraidWebView;
    ...
    protected io.github.krysiel86.mobile.rendering.views.webview.WebViewBase currentWebViewBase;
    ...
    private void readyForMraidExpanded() {
        Log.e("tpmn", "readyForMraidExpanded ");
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        Log.e("tpmn", "onWindowFocusChanged");
    ...
    public io.github.krysiel86.mobile.rendering.views.webview.WebViewBase getOldWebView() {
        return oldWebViewBase;
    }

    public void setOldWebView(io.github.krysiel86.mobile.rendering.views.webview.WebViewBase oldWebView) {
    ...
    public io.github.krysiel86.mobile.rendering.views.webview.WebViewBase getWebView() {
        return webView;
    }
    ...
    protected void renderAdView(io.github.krysiel86.mobile.rendering.views.webview.WebViewBase webViewBase) {
        Log.e("tpmn", "renderAdView");
        if (webViewBase == null) {
    ...
    protected void displayAdViewPlacement(io.github.krysiel86.mobile.rendering.views.webview.WebViewBase webViewBase) {
    ...
    private void renderPlacement(io.github.krysiel86.mobile.rendering.views.webview.WebViewBase webViewBase, int width, int height) {
        Log.e("tpmn", "renderPlacement");
        if (context == null) {
