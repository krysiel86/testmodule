...
import io.github.krysiel86.mobile.rendering.views.webview.mraid.BannerJSInterface;
...
public class WebViewBanner extends WebViewBase {
    ...
    public void setMRAIDInterface() {
        Log.e("tpmn","WebViewBanner setMRAIDInterface");
