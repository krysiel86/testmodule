...
import static io.github.krysiel86.mobile.rendering.views.webview.AdWebViewClient.AdAssetsLoadedListener;
...
public class WebViewBase extends AdWebView implements AdAssetsLoadedListener {
    ...
    Log.e("tpmn","WebViewBase load Url : " + PrebidMobile.SCHEME_HTTPS + "://" + domain + "/");
//    Log.e("tpmn","WebViewBase adHTML : " + adHTML);
    }
    ...
    public void initLoad() {
        Log.e("tpmn", "WebViewBase initLoad()");
...
//        Log.e("tpmn","initLoad() adHTML : " + adHTML);
    }
...
//        Log.e("tpmn","originalHtml : " + originalHtml);
