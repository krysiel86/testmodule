...
package io.github.krysiel86.mobile.rendering.views.webview.mraid;
...
import io.github.krysiel86.mobile.rendering.mraid.methods.MraidEventHandlerNotifierRunnable;
import io.github.krysiel86.mobile.rendering.mraid.methods.MraidScreenMetrics;
import io.github.krysiel86.mobile.rendering.mraid.methods.network.GetOriginalUrlTask;
import io.github.krysiel86.mobile.rendering.mraid.methods.network.RedirectUrlListener;
import io.github.krysiel86.mobile.rendering.networking.BaseNetworkTask;
import io.github.krysiel86.mobile.rendering.networking.parameters.GeoLocationParameterBuilder;
import io.github.krysiel86.mobile.rendering.sdk.ManagersResolver;
import io.github.krysiel86.mobile.rendering.sdk.deviceData.managers.DeviceInfoManager;
import io.github.krysiel86.mobile.rendering.sdk.deviceData.managers.LocationInfoManager;
import io.github.krysiel86.mobile.rendering.utils.broadcast.MraidOrientationBroadcastReceiver;
import io.github.krysiel86.mobile.rendering.utils.device.DeviceVolumeObserver;
import io.github.krysiel86.mobile.rendering.utils.helpers.AppInfoManager;
import io.github.krysiel86.mobile.rendering.utils.helpers.HandlerQueueManager;
import io.github.krysiel86.mobile.rendering.utils.helpers.MraidUtils;
...
import io.github.krysiel86.mobile.rendering.views.webview.mraid.JsExecutor;
import io.github.krysiel86.mobile.rendering.views.webview.mraid.ScreenMetricsWaiter;
...
public class BaseJSInterface implements JSInterface {
    ...
    public void open(String url) {
        Log.e("tpmn", "BaseJSInterface open : " + url);
    ...
    public void handleScreenViewabilityChange(boolean isViewable) {
        Log.e("tpmn", "handleScreenViewabilityChange");
    ...
    public void followToOriginalUrl(String url, final RedirectUrlListener listener) {
        Log.e("tpmn", "followToOriginalUrl");
    ...
    public ViewGroup getRootView() {
        final View bestRootView = io.github.krysiel86.mobile.rendering.views.webview.mraid.Views.getTopmostView(weakActivity.get(), defaultAdContainer);
    ...
    public void prepareAndSendReady() {
         ...
         */
        Log.e("tpmn", "prepareAndSendReady");
    ...
    public void updateScreenMetricsAsync(
        ...
        Log.e("tpmn", "updateScreenMetricsAsync successRunnable");
    ...
    protected void notifyScreenMetricsChanged() {
        Log.e("tpmn", "notifyScreenMetricsChanged run");
    ...
    private void notifyMraidEventHandler() {
        Log.e("tpmn", "notifyMraidEventHandler run");
