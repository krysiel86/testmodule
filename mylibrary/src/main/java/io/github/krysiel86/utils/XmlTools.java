...
public class XmlTools {
    ...
    public static void logXmlDocument(Document doc) {
        ...
        try {
            ...
            Log.e(TAG, "logXmlDocument e.getMessage() : " + e.getMessage());
    ...
    public static String xmlDocumentToString(Document doc) {
        ...
        try {
            ...
            Log.e(TAG, "xmlDocumentToString e.getMessage() : " + e.getMessage());
        }
    ...
    public static Document stringToDocument(String doc) {
        ...
        try {
            ...
            Log.e(TAG, "stringToDocument e.getMessage() : " + e.getMessage());
        }
        return document;
...
//            VASTLog.e(TAG, "getElementValue: " + value);
            return value;
        }
